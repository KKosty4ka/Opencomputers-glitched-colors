local g={} for k,v in pairs(component.proxy(component.list("gpu")())) do g[k]=v end

component.proxy(component.list("gpu")()).setForeground = function( ... )
    g.setForeground( math.random(0x000000, 0xFFFFFF) )
end

component.proxy(component.list("gpu")()).setBackground = function( ... )
    g.setBackground( math.random(0x000000, 0xFFFFFF) )
end
